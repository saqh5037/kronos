...
type WODWithMovements = WODSummary & {
  existingMovements?: {
    movementId: string;
    reps: number | null;
    weight: number | null;
...
export function WODHeroCard({ w, movements = [] }: Props) {
          ...
          <div className="flex items-start justify-between gap-3 mb-3 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="rounded-full px-2.5 py-0.5 font-mono text-[10px] font-bold tracking-wider uppercase transition-colors"
                style={{
                  background: "var(--k-elevated)",
                  color: "var(--k-t2)",
