  ...
  const ld = [
    {
      ...
      description:
        "Reservas, WODs, pagos, asistencia y admin en una sola app, en español, con tu logo y tu color. Para dueños de CrossFit Box en México.",
      inLanguage: "es-MX",
    ...
    },
    {
      ...
      url: `${BASE}/box`,
      description:
        "Software invisible para CrossFit Boxes: reservas con lista de espera, WODs, cobranza con Mercado Pago y efectivo, asistencia, admin de operación y white-label real.",
      featureList: [
        "App del atleta GRATIS para todos los miembros del Box — sin costo extra por usuario",
        "Reservas con lista de espera FIFO",
        "WOD del día + biblioteca de movimientos",
        "Control de asistencia (QR + manual)",
        "Membresías y cobranza con Mercado Pago (tarjeta) y efectivo",
        "PRs y rankings del Box",
        "Pantalla para la TV del Box",
        "Avisos y notificaciones push",
        "White-label visual",
        "Multi-tenant cross-Box",
        "Reportes y exportación en CSV",
      ],
      offers: offers,
