          ...
          {movementInfo?.standardDescription && (
            <AnimatedSection>
              <AnimatedItem>
                <KCard>
                  <div className="p-4">
                    <p className="k-eyebrow mb-2 text-white/60">DESCRIPCIÓN</p>
                    ...
                    {movementInfo.equipment.length > 0 && (
                      <div className="mt-4">
                        <p className="text-[10px] font-mono font-bold tracking-wider text-white/30 uppercase mb-2">
                          Equipo necesario
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {movementInfo.equipment.map((eq) => (
                            <span
                              key={eq}
                              className="inline-flex items-center gap-1.5 bg-[var(--card-2)] border border-[var(--line)] rounded-lg px-2.5 py-1.5 text-xs text-white/70"
                            >
          ...
          <AnimatedSection className="grid grid-cols-2 gap-2">
            <AnimatedItem>
              <KCard variant="flat" className="p-3.5 text-center">
                ...
                <div className="text-[10px] font-bold tracking-wide mt-1 text-white/30">
                  PR ACTUAL{" "}
                  {profile.currentBest
                ...
                {progression && progression.totalAttempts > 0 && (
                  <div className="flex items-center justify-center gap-4 mt-3">
                    <div className="text-center">
                      ...
                      <div className="text-[9px] font-bold tracking-wide text-white/30">
                        INTENTOS
                      </div>
                    </div>
