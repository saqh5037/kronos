...
export default async function FoundingDominusPage() {
  ...
  return (
    <main className="min-h-screen" style={{ background: "var(--k-bg)" }}>
          ...
          <>
            <section className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-10">
              ...
              <BenefitCard
                ...
                desc="Pagás 12 meses upfront, recibís 15. La forma más eficiente de asegurar el precio."
              />
              <BenefitCard
                eyebrow="Founding"
            ...
            <KCard animate={false}>
              <div className="p-6 md:p-8">
                ...
                <p className="text-sm mb-6" style={{ color: "var(--k-t2)" }}>
                  Sin cargo hoy. Te llegan 2 correos: confirmación + magic link
            ...
            <section className="mt-12">
              ...
              <div className="space-y-3">
                <FaqItem
                  ...
                  a="MercadoPago todavía está en proceso de activación. Reservás tu Box al precio fundador y cuando esté listo te mandamos el link de pago — el precio queda lockeado sin importar la fecha."
                />
                <FaqItem
                  q="¿Qué pasa si no quiero seguir tras el trial?"
                  a="Tenés 14 días gratis para explorar. Si no procesás el pago cuando llegue el link, simplemente no se activa la suscripción. Sin cargos sorpresa."
                />
                <FaqItem
                  q="¿Cuántos atletas puedo tener?"
                  a="Hasta 200 atletas y 5 coaches en el plan Founding. Si necesitás más, hablamos."
                />
                <FaqItem
