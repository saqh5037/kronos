...
export default function MovementAdminClient({
  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-4">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-xl text-sm bg-[var(--card)] border border-[var(--line)] focus:outline-none focus:border-[var(--steel)] text-white placeholder:text-white/30"
          />
          {search && (
            <button
              onClick={() => setSearch("")}
            ...
            <button
              ...
              className={`px-3 py-1.5 text-xs font-medium rounded-full transition-colors ${
                activeCategory === cat.key
                  ? "bg-[var(--card-elevated)] text-white border border-[var(--line-strong)]"
      ...
      <p className="text-[11px] text-white/30 font-mono uppercase tracking-wider mb-3">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-[var(--line)]">
              <th className="text-left p-3 text-white/30 font-mono text-[10px] uppercase tracking-wider w-16">
                Miniatura
              </th>
              <th className="text-left p-3 text-white/30 font-mono text-[10px] uppercase tracking-wider">
                Nombre
              </th>
              <th className="text-left p-3 text-white/30 font-mono text-[10px] uppercase tracking-wider">
                Categoría
        ...
        {selectedId && selected && (
          ...
          >
            ...
            >
              ...
              <label className="block text-[11px] font-mono font-bold tracking-wider text-white/30 uppercase mb-1.5">
              ...
              <input
                ...
                className="w-full px-3 py-2.5 rounded-xl text-sm bg-[var(--card-2)] border border-[var(--line)] focus:outline-none focus:border-[var(--steel)] text-white placeholder:text-white/20 mb-4"
              />
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={closeEdit}
                  className="k-btn-ghost px-4 py-2.5 text-sm text-white/40 hover:text-white/70"
                >
                  Cerrar
                </button>
              </div>
