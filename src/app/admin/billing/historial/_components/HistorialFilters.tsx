    ...
    <div className="k-card p-4 md:p-5 mb-4">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
        <div>
          <label
            htmlFor="filter-from"
            className="block text-xs font-mono uppercase tracking-wider text-[var(--text-3)] mb-1"
          >
            Desde
          </label>
          <input
            ...
            className="w-full rounded-lg p-2 bg-[var(--bg-soft)] border border-[var(--border)] text-[var(--text)] text-sm focus:outline-none focus:border-[var(--strain)]"
          />
        </div>
        <div>
          <label
